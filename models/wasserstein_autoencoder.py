...
def load_if(checkpoints_path: Optional[str], network: nn.Module, map_location=None) -> nn.Module:
    """
...
def init_wasserstein_autoencoder(checkpoints_path: Optional[str] = None, map_location=None) -> nn.Module:
    """
    ...
    return load_if(checkpoints_path, autoencoder,map_location)

def init_wasserstein_autoencoder_inter(checkpoints_path: Optional[str] = None, map_location=None) -> nn.Module:
    """
    Load the KL autoencoder (pretrained if `checkpoints_path` points to previous params).
...
def init_patch_discriminator(checkpoints_path: Optional[str] = None, map_location=None) -> nn.Module:
    """
    ...
    patch_discriminator = PatchDiscriminator(spatial_dims=3,
                                             ...
                                             in_channels=1,
                                             out_channels=1)
    return load_if(checkpoints_path, patch_discriminator,map_location)